...
export function About() {
  return (
    <div  style={{height:'800px',width:'1500px'}}>
      ...
      <h1>About</h1>
      <Card.Img className="rounded-circle"  src="./image/Band Members.png" variant="left"  style ={{height:'200px'}}>
      </Card.Img>


      <p style={{backgroundColor: 'white', fontFamily:"Arial" ,textAlign:'center'}}>
